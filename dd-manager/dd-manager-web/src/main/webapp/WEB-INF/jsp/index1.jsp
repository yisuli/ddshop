...
<div data-options="region:'north'" style="height:70px;padding-left:10px;background: #00a2d4;">
    <h2>千锋纵横小说后台管理系统</h2>
</div>
    ...
    <div id="menu" class="easyui-accordion">
        <div title="商品管理" data-options="selected:true,iconCls:'icon-tip'" style="padding:10px 0;">
            <ul class="easyui-tree">
                <li data-options="attributes:{'href':'reader-add'}">新增商品</li>
...
<div data-options="region:'center'">
    <div id="tab" class="easyui-tabs" data-options="fit:true">
        <div title="欢迎页面" style="padding:20px;"><img src="images/bg_welcome.png" width="100%" height="100%"></div>
    </div>
</div>
<!-- jquery -->
